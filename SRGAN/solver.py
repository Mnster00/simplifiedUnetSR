...
class SRGANTrainer(object):
    ...
    def build_model(self):
        ...
        self.feature_extractor = vgg16(pretrained=True)#True
        ...
        print('# model parameters:', sum(param.numel() for param in self.netG.parameters()))
        print('# model parameters:', sum(param.numel() for param in self.netD.parameters()))
